package eu.claudius.iacob.maidens.skins {
	...
	import eu.claudius.iacob.maidens.skins.images.generatorsNodeIcon;
	
	/**
	 *  The skin for the close button in the TitleBar
	 *  of a WindowedApplication or Window.
	 */
	public class GeneratorsSkin extends FXGButtonSkin {
		...
		override protected function get upSkin() : Class {
			return generatorsNodeIcon;
		}
		
		override public function get measuredWidth():Number {
			return Sizes.TREE_ICON_SIZE;
		}
