package eu.claudius.iacob.maidens.skins {
	...
	import eu.claudius.iacob.maidens.skins.images.fitToWidth;
	import eu.claudius.iacob.maidens.skins.images.prevPage;
	import eu.claudius.iacob.maidens.skins.images.stop;
	
	/**
	 *  The skin for the close button in the TitleBar
	 *  of a WindowedApplication or Window.
	 */
	public class PrevPageSkin extends FXGButtonSkin {
