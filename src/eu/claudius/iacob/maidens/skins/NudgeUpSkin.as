package eu.claudius.iacob.maidens.skins {
	...
	import eu.claudius.iacob.maidens.skins.images.nudgeUp;
	import eu.claudius.iacob.maidens.skins.images.playback;
	
	/**
	 *  The skin for the close button in the TitleBar
	 *  of a WindowedApplication or Window.
	 */
	public class NudgeUpSkin extends FXGButtonSkin {
